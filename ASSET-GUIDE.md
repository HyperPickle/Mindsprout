...
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------- | ----------------- | ------------------ | ------------------------------------------------------------------------ |
| `HomeBackground`       | `[HomeTab.swift](Mindsprout/Features/Sprout/HomeTab.swift)`                                                                     | Light/dark `1290x2796` JPG                   | `0.46:1` portrait  | Full-screen home background, rendered with `.scaledToFill()`             |
